...
from .views import (
    ...
    CreditCustomerStatementView,
    CreditCustomerPaymentCreateView,
...
urlpatterns = [
    ...
    path("credit/customer/<uuid:customer_id>/statement/", CreditCustomerStatementView.as_view(), name="credit-customer-statement"),
    path("credit/customer/<uuid:customer_id>/payments/", CreditCustomerPaymentCreateView.as_view(), name="credit-customer-payment"),
    ...
    path("mobile/summary/", MobileSalesSummaryView.as_view(), name="mobile-sales-summary"),
    path("mobile/", MobileSalesListView.as_view(), name="mobile-sales-list"),
